    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${pageContext.request.contextPath}/product/toSearchProduct.action" class="list-group-item active">商品查询</a>
            </div>
        </div>
        <div class="col-md-10">
            <ul class="nav nav-tabs">
             ...
             <!-- 商品搜索表单  begin -->
		            <form id="form-add" action="${pageContext.request.contextPath}/product/searchProduct.action"enctype="multipart/form-data"  method="post" class="form_border">
