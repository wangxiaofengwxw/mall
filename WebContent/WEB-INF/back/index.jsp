...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${ctx}/resources/h/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx}/resources/h/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element" style="margin-left: 20px">
                            <span><img alt="image" class="img-circle" src="${ctx}/resources/h/img/wang.jpg" width="80px"height="80px"/></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">王晓峰</strong></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">商品列表</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">商品操作</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${ctx}/Hproduct/list.action">列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/Hproduct/toAdd.action">添加商品</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/Hproduct/toCategoryList.action">添加分类</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/Hproduct/toSearchProduct.action">商品搜索</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${ctx}/resources/h/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${ctx}/resources/h/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index_v1.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless>
                </iframe> 
            </div>
            <div class="footer">
    ...
    <!-- 全局js -->
    <script src="${ctx}/resources/h/js/jquery.min.js?v=2.1.4"></script>
    <script src="${ctx}/resources/h/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="${ctx}/resources/h/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${ctx}/resources/h/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${ctx}/resources/h/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="${ctx}/resources/h/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="${ctx}/resources/h/js/contabs.js"></script>

    <!-- 第三方插件 -->
    <script src="${ctx}/resources/h/js/plugins/pace/pace.min.js"></script>
