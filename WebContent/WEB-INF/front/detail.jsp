...
<html>
	<head>
		...
		<link rel="stylesheet" href="${ctx}/resources/front/css/detail_style.css" />
	...
	<body>
		...
		<div class="logo_center">
			...
			<div class="right">
				<a style="color: #666666;" href="${ctx }/index/Cart.shtml">去购物车结算</a>
				<div class="logo_nav">
				</div>
			</div>
			<div class="clearfix"></div>
			...
			<div class="left">
				<ul>
					<li class="banner_center_left_top">
						<img src="${product.fullUrl }"  style="width: 250px;height: 400px;margin-left: 40px"/>
					</li>
					<li class="banner_center_left_center">
						<ul>
							...
							<c:forEach items="${arraySub }" var="sub">
								<li class="small_shop"><img alt="" src="${sub }" style="width: 50px"></li>
							</c:forEach>
		...
		<div class="surper_big">
			...
			<div class="right_big">
				${product.detail }
				<%-- <div class="big_img">
					<img src="${ctx}/resources/front/img/tu.png" />
				</div> --%>
